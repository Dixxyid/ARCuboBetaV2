...
export const celestialData = {
  earth: {
    ...
    displaySize: 0.15, // Ukuran tampil di AR (unit relatif terhadap lebar marker)
  ...
  mars: {
    ...
    displaySize: 0.10, // Mars dibuat sedikit lebih kecil dari Bumi sesuai proporsi visual
